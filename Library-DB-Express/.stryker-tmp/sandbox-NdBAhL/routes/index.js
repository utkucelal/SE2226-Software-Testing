...
router.get(stryMutAct_9fa48("74") ? "" : (stryCov_9fa48("74"), '/books/:id'), asyncHandler(async (req, res, next) => {
  if (stryMutAct_9fa48("75")) {
    {}
  } else {
    stryCov_9fa48("75");
    const book = await Book.findByPk(req.params.id);
    if (stryMutAct_9fa48("78") ? false : stryMutAct_9fa48("77") ? true : stryMutAct_9fa48("76") ? book : (stryCov_9fa48("76", "77", "78"), !book)) {
      if (stryMutAct_9fa48("79")) {
        {}
      } else {
        stryCov_9fa48("79");
        const err = new Error(stryMutAct_9fa48("80") ? "" : (stryCov_9fa48("80"), 'Book Not Found'));
        err.status = 404;
        return next(err);
      }
    }
    res.render(stryMutAct_9fa48("81") ? "" : (stryCov_9fa48("81"), 'update-book'), stryMutAct_9fa48("82") ? {} : (stryCov_9fa48("82"), {
      book,
      title: book.title
    }));
  }
...
router.post(stryMutAct_9fa48("83") ? "" : (stryCov_9fa48("83"), '/books/:id'), asyncHandler(async (req, res) => {
      ...
      if (stryMutAct_9fa48("87")) {
        ...
        if (stryMutAct_9fa48("90") ? error.name !== 'SequelizeValidationError' : stryMutAct_9fa48("89") ? false : stryMutAct_9fa48("88") ? true : (stryCov_9fa48("88", "89", "90"), error.name === (stryMutAct_9fa48("91") ? "" : (stryCov_9fa48("91"), 'SequelizeValidationError')))) {
          if (stryMutAct_9fa48("92")) {
            ...
            res.render(stryMutAct_9fa48("94") ? "" : (stryCov_9fa48("94"), 'update-book'), stryMutAct_9fa48("95") ? {} : (stryCov_9fa48("95"), {
              errors,
              book,
              title: book.title
            }));
...
router.post(stryMutAct_9fa48("97") ? "" : (stryCov_9fa48("97"), '/books/:id/delete'), asyncHandler(async (req, res) => {
  if (stryMutAct_9fa48("98")) {
    ...
    const book = await Book.findByPk(req.params.id);
    await book.destroy();
    res.redirect(stryMutAct_9fa48("99") ? "" : (stryCov_9fa48("99"), '/books'));
  }
}));
